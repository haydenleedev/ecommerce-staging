  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.clearfix}>
        <button
          className={`${icons['btn']} ${icons['btn-white']} ${icons['btn-big']}`}
        >
          <span>Back</span>
        </button>
        <button
          className={`${icons['btn']} ${icons['btn-orange']} ${icons['btn-big']}`}
        >
          <span>Continue</span>
        </button>
        <button
          className={`${icons['btn']} ${icons['btn-blue']} ${icons['btn-big']}`}
        >
          <span>Buy Now</span>
        </button>
        <button
          className={`${icons['btn']} ${icons['btn-blue']} ${icons['btn-small']}`}
        >
          <span>Try Now</span>
        </button>
        <button
          className={`${icons['btn']} ${icons['btn-skyblue']} ${icons['btn-medium']}`}
        >
      ...
      <div
        className={`${styles['grid-col-4']} ${styles['pt-30px']} ${styles['pb-30px']}`}
      >
        <div className={styles.relative}>
          <span>All Core Channels*</span>
          <span className={icons['tooltip-wrap']}>
            <span className={icons['tooltip']}>
              Support for inbound calls over the PSTN as well as outbound
              calling via the agent dialpad or click-to-call within the CRM.
            </span>
          </span>
        </div>
      </div>
      ...
      <div className={styles.relative}>
        <span className={icons['radio-btn']}></span>
      </div>
